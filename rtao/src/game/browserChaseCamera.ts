/**
 * Browser presentation fallback for chase framing. This is host policy, not a
 * recovered PAL camera model. Keep it until an end-to-end numeric PAL camera
 * trace proves the output-builder projection and lag units.
 */
