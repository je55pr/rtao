...
A refactor PR should preserve behavior and use existing tests/captures to demonstrate that preservation. A behavior PR should focus on the recovered behavior and its evidence rather than carrying unrelated architectural churn.
...
- Exceptions are allowed only when separation would materially increase risk or duplicate work, and the PR should explain why.
